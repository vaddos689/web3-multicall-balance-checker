...
from core.modules.utils.helpers import round_to
from core.modules.utils.multicall import Multicall
...
class EvmBalanceChecker:
    ...
    async def evm_balances(self):
        ...
        tasks = [Multicall(chain).get_balances(WALLETS, tokens, symbols_list, decimals_list) for chain, tokens in
                 Value_EVM_Balance_Checker.evm_tokens.items() if tokens]
